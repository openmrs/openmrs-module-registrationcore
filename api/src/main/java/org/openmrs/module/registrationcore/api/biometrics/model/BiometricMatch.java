...
/**
 * Represents a possible biometric match as a result of searching a biometric database for matches
 * on a given subject The matchScore is a numeric that indicates the strength of the match
 */
