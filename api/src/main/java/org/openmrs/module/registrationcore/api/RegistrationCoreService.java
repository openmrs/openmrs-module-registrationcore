...
public interface RegistrationCoreService extends OpenmrsService {
    ...
    /**
     * Assigns an identifier to the patient and saves them in the database including the specified relationships, the
     * method always attempts to set the other side of each relationship therefore callers of this method are required
     * to set exactly one side
     *
     * @param patient
     *            the patient to save
     * @param relationships
     *            the relationships to save along with the patient
     * @param identifierLocation
     *            the location to set for the patient identifier, if not specified, it defaults to the system default
     *            locale see {@link LocationService#getDefaultLocation()}
     ...
     *            the identifier to use for the patient
     * @param identifierLocation
     *            the location to set for the patient identifier, if not specified, it defaults to the system default
     *            locale see {@link LocationService#getDefaultLocation()}
     * @return the created patient
    ...
    /**
     * Import a specific patient by sending Query to MPI server to find patient with identifier and save that patient to
     * local DB.
     *
     * @param personId
    ...
    /**
     * Import a specific patient by sending Query to MPI server to find patient with Identifier of IdentifierType with
     * IdentifierTypeUuid provided. and save that patient to local DB.
     *
     ...
     *
     * @param patient
     *            patient to save biometric data to
     * @param biometricData
     *            biometric data to save to the patient
     */
