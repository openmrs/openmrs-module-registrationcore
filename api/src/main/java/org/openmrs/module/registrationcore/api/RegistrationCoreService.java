...
public interface RegistrationCoreService extends OpenmrsService {
	...
	/**
	 * Import a specific patient by sending Query to MPI server to find patient with Identifier of
	 * IdentifierType with IdentifierTypeUuid provided. and save that patient to local DB.
	 * 
