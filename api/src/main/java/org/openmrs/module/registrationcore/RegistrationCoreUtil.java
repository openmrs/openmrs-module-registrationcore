...
public class RegistrationCoreUtil {
    ...
    /**
     * Converts an age (specified in year, month, and day) to a birthdate. You can specify the specific date to
     * calculate the age from, or, if not specified, today's date is used. Year, month, or day can all be left blank.
     *
     ...
     *
     *      For example, if ageOnDate is set to April 3, 2010, and someone is said to be 10 years old, the method would
     *      return January 1, 2000; if someone is said to be 2 months old, the method would return February 1, 2000
     */
    ...
    public static int getEstimationStartMonth() {
        ...
        if (StringUtils.isNotBlank(gpStartMonth)) {
            try {
                ...
                log.warn("Unable to parse value of " + RegistrationCoreConstants.GP_BIRTHDATE_ESTIMATION_START_MONTH,
                        nfe);
            }
        }
