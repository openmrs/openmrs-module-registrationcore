...
public final class RegistrationCoreConstants {
	...
	/**
	 * Specifies the runtime property for the MPI Username defined in the
	 * .OpenMRS/openmrs-runtime.properties file
	 */
	public static final String RTP_MPI_ACCESS_USERNAME = "registrationcore.mpi.username";
	
	/**
	 * Specifies the runtime property for the MPI Password defined in the
	 * .OpenMRS/openmrs-runtime.properties file
	 */
