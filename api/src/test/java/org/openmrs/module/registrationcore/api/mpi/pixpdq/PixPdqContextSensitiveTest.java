...
public class PixPdqContextSensitiveTest extends BaseRegistrationCoreSensitiveTest {
    ...
    @Verifies(value = "should not export patient to the mpi", method = "exportPatient(Patient)")
    ...
    /**
     * Note: Requires openmrs-core version 2.2.0-SNAPSHOT for constructor method to create patient from a provided
     * patient
     *
    ...
    public void filterByIdentifierAndIdentifierType_ContextSensitiveShouldReturnEmptyList() throws Exception {
        ...
        List<MpiPatient> resultList = pixPdqMessageUtil.filterByIdentifierAndIdentifierType(inputList, "1000X1",
